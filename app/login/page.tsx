      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: "var(--text-secondary)" }}>
            Use your city workspace account
          </p>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              style={{
                background: loading === "google" ? "var(--bg-tertiary)" : "var(--bg-primary)",
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border text-sm font-medium transition-colors"
              style={{
                background: loading === "azure-ad" ? "var(--bg-tertiary)" : "var(--bg-primary)",
                borderColor: "var(--border)",
                color: loading ? "var(--text-muted)" : "var(--text-primary)",
                cursor: loading ? "not-allowed" : "pointer",
              }}
        ...
        <p className="text-xs text-center mt-6" style={{ color: "var(--text-muted)" }}>
          &copy; {new Date().getFullYear()} LocalGov Compliance Platform
        </p>
      </div>
    </div>
  );
